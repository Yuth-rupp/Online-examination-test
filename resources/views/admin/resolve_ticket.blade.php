...
<head>
    ...
    <meta name="description" content="Resolve support ticket — {{ $platformName }} Admin Panel">
    <title>Resolve Ticket #{{ $ticket->ticket_no }} — {{ $platformName }} Admin</title>
    ...
    <style>
        /* ═══════════════════════════════════════════════
           DESIGN SYSTEM — matches all {{ $platformName }} pages
        ═══════════════════════════════════════════════ */
        :root {
            --sidebar-w      : 256px;
            --body-bg        : #f1f5f9;
