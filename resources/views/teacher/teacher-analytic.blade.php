...
<aside class="w-[260px] bg-white border-r border-slate-100 flex flex-col flex-shrink-0 h-screen z-20 shadow-sm">
    ...
    <nav class="flex-1 px-2.5 py-3 space-y-0.5 overflow-y-auto">
        ...
        <a href="{{ route('teacher.analytics') }}"       class="nl act"><span class="ni"><i class="fa-solid fa-chart-line text-xs"></i></span><span>Analytics</span></a>
    ...
    <div class="p-2.5 border-t border-slate-100 flex-shrink-0">
        <a href="{{ route('teacher.settings') }}" class="flex items-center gap-2.5 px-2 py-2 rounded-xl hover:bg-slate-50 transition-colors">
...
<div class="flex-1 flex flex-col min-w-0 overflow-hidden">
    ...
    {{-- ── HEADER ── --}}
    <div class="flex-shrink-0" style="background:linear-gradient(135deg,#0F172A 0%,#1E3A5F 55%,#1E40AF 100%)">
