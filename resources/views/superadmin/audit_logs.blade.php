...
<head>
    ...
    <style>
        ...
        .tab-btn{padding:7px 16px;border-radius:9px;font-size:11px;font-weight:700;
                 cursor:pointer;letter-spacing:0.04em;text-transform:uppercase;border:none;transition:all 0.2s;}
    ...
    <main class="flex-1 ml-64 min-h-screen flex flex-col">
        ...
        <header class="sticky top-0 z-10 border-b border-slate-100 h-16 flex items-center px-8 gap-4"
            ...
            <div class="flex items-center gap-3 ml-auto flex-wrap">
                ...
                <div id="read-only-badge"
                     class="flex items-center gap-2 text-xs font-semibold bg-slate-100 text-slate-500 border border-slate-200 px-3 py-1.5 rounded-lg">
        ...
        <div class="p-8 flex-1" style="display:flex;flex-direction:column;gap:20px;">
            ...
            {{-- NEW EVENTS BANNER (hidden by default) --}}
            <div id="new-events-banner" class="slide-down hidden items-center justify-between gap-4 rounded-2xl px-5 py-3.5 border"
                ...
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-xl bg-blue-500 flex items-center justify-center flex-shrink-0 new-pulse">
                    ...
                    <p class="text-sm font-bold text-blue-900">
                        ...
                        <span id="new-events-label"> new events captured since last sync</span>
                    </p>
                </div>
                <button onclick="flushNewEvents()"
                        class="flex items-center gap-2 text-xs font-bold text-white px-4 py-2 rounded-xl transition-all"
            ...
            {{-- SCOPE BANNER --}}
            <div class="flex items-start gap-3 bg-violet-50 border border-violet-100 rounded-2xl px-5 py-4"
                ...
                <div class="w-8 h-8 rounded-xl bg-violet-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <i class="fa-solid fa-shield-halved text-violet-600 text-sm"></i>
                </div>
                <div>
                    ...
                    <p class="text-[11px] text-violet-700 font-medium leading-relaxed">
                        Standard Admins see only their own action history in their local workspace.
            ...
            <div class="grid grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-2xl border border-slate-100 p-5 flex items-center gap-4 cursor-default transition-all duration-300"
                    ...
                    <div>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Events Today</p>
                        <p id="card-today" class="text-2xl font-black text-slate-900 leading-none tabular-nums">
                            <span class="skeleton" style="height:28px;width:48px;"></span>
                        </p>
                    </div>
                </div>

                <div class="bg-white rounded-2xl border border-rose-100 p-5 flex items-center gap-4 cursor-default transition-all duration-300"
                     style="box-shadow:0 1px 4px rgba(148,163,184,0.06);background:linear-gradient(135deg,#fff 70%,rgba(255,241,242,0.4) 100%);"
                     onmouseenter="this.style.boxShadow='0 8px 24px rgba(244,63,94,0.10)';this.style.transform='translateY(-2px)'"
                     onmouseleave="this.style.boxShadow='0 1px 4px rgba(148,163,184,0.06)';this.style.transform='none'">
                    <div class="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                    ...
                    <div>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Critical Actions</p>
                        <p id="card-critical" class="text-2xl font-black text-rose-600 leading-none tabular-nums">
                ...
                <div class="bg-white rounded-2xl border border-slate-100 p-5 flex items-center gap-4 cursor-default transition-all duration-300"
                    ...
                    <div class="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                        ...
                        <i class="fa-solid fa-user-secret text-violet-500 text-sm"></i>
                    </div>
                    <div>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Unique Actors</p>
                        <p id="card-actors" class="text-2xl font-black text-violet-600 leading-none tabular-nums">
                            <span class="skeleton" style="height:28px;width:40px;"></span>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-100 p-5 flex items-center gap-4 cursor-default transition-all duration-300"
                    ...
                    <div class="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                        ...
                        <i class="fa-regular fa-clock text-emerald-500 text-sm"></i>
                    </div>
                    <div>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Last Event</p>
                        <p id="card-last" class="text-sm font-black text-emerald-600 leading-none" style="font-size:12px;">
                            <span class="skeleton" style="height:28px;width:64px;"></span>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="px-6 py-4 border-b border-slate-100 flex flex-wrap items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 ml-auto flex-wrap">
                        ...
                        <div class="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2">
                            ...
                            <input id="search-actor" type="text" placeholder="Search by actor..."
                                   oninput="renderLogs()"
                                   class="text-xs font-medium text-slate-700 bg-transparent outline-none placeholder-slate-300"
                                   style="width:160px;">
                        </div>
                        ...
                        <div class="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2">
                            ...
                            <input id="search-action" type="text" placeholder="Search action..."
                                   oninput="renderLogs()"
                                   class="text-xs font-medium text-slate-700 bg-transparent outline-none placeholder-slate-300"
                                   style="width:140px;">
                        </div>
                        ...
                        <button onclick="clearFilters()"
                                class="text-xs font-bold text-slate-400 hover:text-slate-700 px-3 py-2 rounded-xl hover:bg-slate-100 transition-all">
...
function getSeverity(action) {
    ...
    if (a.includes('create') || a.includes('update') || a.includes('suspend') || a.includes('activate'))
...
const actorGradMap = {};
let gradIdx = 0;
function actorGrad(name) {
    if (!actorGradMap[name]) {
        actorGradMap[name] = ACTOR_GRADS[gradIdx++ % ACTOR_GRADS.length];
    }
    return actorGradMap[name];
}
...
setInterval(()=>{
    pollCount--;
    if(pollCount<=0){ pollCount=4; checkIncomingLogs(); }
...
// PRODUCTION: This is the server-side hydration; replace with your API call
const serverLogs = {!! json_encode($auditLogs ?? []) !!};


// ============================================================
//  MOCK / SAMPLE DATA  ← Remove when API is wired
// ============================================================
function generateMockLogs() {
    return [
        { operator:'You Phatyou',    role:'super_admin', action:'emergency.force_end_exam',    resource:'Exam #1007 (Accounting)',    ip:'192.168.1.1',  created_at:'2026-07-15 18:28:01' },
        { operator:'You Phatyou',    role:'super_admin', action:'policy.disable_tab_detection', resource:'System-Wide Policy Override', ip:'192.168.1.1',  created_at:'2026-07-15 18:25:44' },
        { operator:'Meow Meow',      role:'admin',       action:'user.create_account',           resource:'User: Yun Dalin (Teacher)',   ip:'10.0.0.12',    created_at:'2026-07-15 18:20:19' },
        { operator:'Meow Meow',      role:'admin',       action:'user.suspend_account',          resource:'User: crs crs (Student)',     ip:'10.0.0.12',    created_at:'2026-07-15 18:18:55' },
        { operator:'You Phatyou',    role:'super_admin', action:'settings.update_global_config', resource:'Backup Schedule Config',     ip:'192.168.1.1',  created_at:'2026-07-15 17:55:30' },
        { operator:'Meow Meow',      role:'admin',       action:'exam.update_settings',          resource:'Exam: Physics Final',        ip:'10.0.0.12',    created_at:'2026-07-15 17:44:11' },
        { operator:'You Phatyou',    role:'super_admin', action:'role.change_user_role',         resource:'User: Meow Meow → Admin',    ip:'192.168.1.1',  created_at:'2026-07-15 17:30:00' },
        { operator:'Meow Meow',      role:'admin',       action:'user.activate_account',         resource:'User: Yun Dalin (Teacher)',   ip:'10.0.0.12',    created_at:'2026-07-15 17:22:05' },
        { operator:'You Phatyou',    role:'super_admin', action:'backup.trigger_manual_backup',  resource:'Database Snapshot v4.2.1',   ip:'192.168.1.1',  created_at:'2026-07-15 16:59:48' },
        { operator:'Meow Meow',      role:'admin',       action:'exam.create',                   resource:'Exam: Biology Midterm',       ip:'10.0.0.12',    created_at:'2026-07-15 16:40:22' },
        { operator:'You Phatyou',    role:'super_admin', action:'settings.toggle_lockdown_mode', resource:'Lockdown Mode → Enabled',    ip:'192.168.1.1',  created_at:'2026-07-15 15:15:09' },
        { operator:'Meow Meow',      role:'admin',       action:'user.create_account',           resource:'User: Test Student',         ip:'10.0.0.12',    created_at:'2026-07-15 14:50:33' },
    ];
}
...
function updateCards(){
    ...
    const uniqueActors=[...new Set(allLogs.map(l=>l.operator))];
    const latest=allLogs[0];

    setMetric('card-today',    todayLogs.length);
    setMetric('card-critical', criticals.length);
    setMetric('card-actors',   uniqueActors.length);

    if(latest){
        const t=latest.created_at||'—';
        document.getElementById('card-last').textContent=t.slice(11,16)||t;
    }
}
...
function filteredLogs(){
    ...
    return allLogs.filter(log=>{
        ...
        const matchActor =(log.operator||'').toLowerCase().includes(actor);
        const matchAction=(log.action  ||'').toLowerCase().includes(action);
        return matchTab && matchActor && matchAction;
    });
}
...
function renderLogs(){
    ...
    if(!logs.length){
        tbody.innerHTML=`<tr><td colspan="5" style="padding:48px;text-align:center;color:#94a3b8;">
            ...
            <p style="font-size:12px;font-weight:600;">No events match your current filters</p>
            </td></tr>`;
        return;
    }
    ...
    tbody.innerHTML=logs.map((log,i)=>{
        ...
        return `
        <tr class="log-row fade-in" style="animation-delay:${delay}ms;transition:background 0.12s;cursor:default;">
            <td style="padding:14px 24px;">
                <div style="display:flex;align-items:center;gap:10px;">
                    <div style="width:36px;height:36px;border-radius:10px;flex-shrink:0;
                                background:${grad};display:flex;align-items:center;justify-content:center;
                                font-size:12px;font-weight:800;color:#fff;">${init}</div>
                    <div>
                        <div style="display:flex;align-items:center;gap:4px;">
                            <p style="font-size:13px;font-weight:700;color:#0f172a;">${log.operator}</p>
                            ${rolePill}
                        </div>
                    </div>
                </div>
            ...
            <td style="padding:14px 16px;font-size:12px;color:#475569;font-weight:500;max-width:200px;">
                <span style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:block;max-width:190px;"
                      title="${log.resource}">${log.resource}</span>
            </td>
            <td style="padding:14px 16px;text-align:center;">
                <span style="display:inline-flex;align-items:center;gap:5px;font-size:10px;font-weight:800;
                             text-transform:uppercase;letter-spacing:0.05em;padding:4px 10px;
                             border-radius:8px;border:1px solid;
                             background:${sv.bg};color:${sv.color};border-color:${sv.border};">
                    <i class="fa-solid ${sv.icon}" style="color:${sv.iconC};font-size:9px;"></i>
                    ${sv.label}
                </span>
            </td>
            <td style="padding:14px 16px;text-align:right;">
                <p style="font-size:11px;font-weight:700;color:#475569;font-family:'JetBrains Mono',monospace;">${ts}</p>
                <p style="font-size:10px;color:#94a3b8;font-weight:500;margin-top:2px;font-family:'JetBrains Mono',monospace;">
                    <i class="fa-solid fa-location-dot" style="font-size:9px;margin-right:3px;"></i>${ip}
                </p>
            </td>
        </tr>`;
    }).join('');
...
//  NEW EVENTS BANNER
// ============================================================
function showNewEventsBanner(count){
    const banner=document.getElementById('new-events-banner');
    document.getElementById('new-events-count').textContent=count;
    document.getElementById('new-events-label').textContent=
        ` new event${count>1?'s':''} captured — click Sync View to load`;
...
function flushNewEvents(){
    ...
    hideNewEventsBanner();
    showToast('<i class="fa-solid fa-rotate" style="color:#60a5fa;font-size:13px;"></i><span style="margin-left:8px;">Audit trail synced to latest.</span>');
}
...
//  API: INITIAL LOAD
// ============================================================
async function syncLatestAuditLogs(){
    try{
        const res=await fetch("{{ route('superadmin.telemetry.livefeed') }}",{headers:{'Accept':'application/json'}});
        if(res.ok){
            const data=await res.json();
            if(data.feed && data.feed.length>0){
                allLogs=data.feed; updateCards(); renderLogs(); return;
            }
        }
    }catch(e){}
    // Fall back to mock / Blade-injected data
    allLogs = serverLogs.length>0 ? serverLogs : generateMockLogs();
    updateCards();
    renderLogs();
}
...
// ============================================================
//  API: POLL FOR NEW EVENTS
// ============================================================
async function checkIncomingLogs(){
    try{
        const res=await fetch("{{ route('superadmin.telemetry.livefeed') }}",{headers:{'Accept':'application/json'}});
        if(res.ok){
            const data=await res.json();
            if(data.feed){
                const diff=data.feed.length-allLogs.length;
                if(diff>0){
                    cachedNew=data.feed;
                    showNewEventsBanner(diff);
                } else if(allLogs.length===0){
                    allLogs=data.feed; updateCards(); renderLogs();
                }
            }
        }
    }catch(e){}
