  ...
  <script>
    document.addEventListener('alpine:init', () => {
      Alpine.data('dashboardApp', () => ({
        ...
        // This student's department, with its current teachers and admins.
        // Seeded from the initial page load, then kept fresh by the same
        // 15s poll that refreshes exams/scores below.
        department: @json($departmentPayload ?? null),
        ...
        async syncDashboardFromServer() {
          try {
            ...
            // Keep the department's teacher/admin list current — picks up
            // a newly assigned teacher or admin without a page reload.
